...
class ChatActionContext : public NamedObjectContext<Action>
{
    public:
        ChatActionContext()
        {
            ...
            creators["molten core chat shortcut"] = &ChatActionContext::molten_core_chat_shortcut;
    ...
    private:
        ...
        static Action* molten_core_chat_shortcut(PlayerbotAI* ai) { return new MoltenCoreChatShortcutAction(ai); }
};
