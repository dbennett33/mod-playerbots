#include "RaidMoltenCoreStrategy.h"
#include "RaidMoltenCoreMultipliers.h"


void RaidMoltenCoreStrategy::InitTriggers(std::vector<TriggerNode*> &triggers)
{
	//// Grobbulus
...
void RaidMoltenCoreStrategy::InitMultipliers(std::vector<Multiplier*> &multipliers)
{
