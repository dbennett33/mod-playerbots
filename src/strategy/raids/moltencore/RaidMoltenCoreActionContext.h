...
#ifndef _PLAYERBOT_RAIDMOLTENCOREACTIONCONTEXT_H
#define _PLAYERBOT_RAIDMOLTENCOREACTIONCONTEXT_H

#include "Action.h"
#include "NamedObjectContext.h"
#include "RaidMoltenCoreActions.h"

class RaidMoltenCoreActionContext : public NamedObjectContext<Action>
{
    public:
        RaidMoltenCoreActionContext() {
