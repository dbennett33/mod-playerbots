...
#ifndef _PLAYERBOT_RAIDMOLTENCORETRIGGERCONTEXT_H
#define _PLAYERBOT_RAIDMOLTENCORETRIGGERCONTEXT_H

#include "NamedObjectContext.h"
#include "AiObjectContext.h"
#include "RaidMoltenCoreTriggers.h"

class RaidMoltenCoreTriggerContext : public NamedObjectContext<Trigger>
{
    public:
        RaidMoltenCoreTriggerContext()
        {
